...
USER_PERMISSIONS_WORKSPACE_CHECKLISTS_ACCESS = (
    os.environ.get("USER_PERMISSIONS_WORKSPACE_CHECKLISTS_ACCESS", "False").lower()
    == "true"
)
...
USER_PERMISSIONS_WORKSPACE_CHECKLISTS_ALLOW_PUBLIC_SHARING = (
    os.environ.get(
        "USER_PERMISSIONS_WORKSPACE_CHECKLISTS_ALLOW_PUBLIC_SHARING", "False"
    ).lower()
    == "true"
)
...
DEFAULT_USER_PERMISSIONS = {
    "workspace": {
        ...
        "checklists": USER_PERMISSIONS_WORKSPACE_CHECKLISTS_ACCESS,
    ...
    "sharing": {
        ...
        "public_checklists": USER_PERMISSIONS_WORKSPACE_CHECKLISTS_ALLOW_PUBLIC_SHARING,
